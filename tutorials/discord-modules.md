...
go [here](https://github.com/Syncxv/discord-stuff/blob/master/tutorials/modules.md) for more about general modules
...
this is what each module will look like

```js
const module = { id: 1, loaded: true, exports: {} };
```

the exports object is coverd in detail [here](https://github.com/Syncxv/discord-stuff/blob/master/tutorials/modules.md)
